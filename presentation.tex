...
\par The goal is to find optimal energy extraction strategies in unsteady flows.
\begin{itemize}
  \item UAV energy saving
  \item Vertical axis wind turbine
  \item Helicopter rotor blade
\end{itemize}

\par How do vehicle dynamics relate to unsteady aerodynamic effects 

\par When do these unsteady effects start to become significant
